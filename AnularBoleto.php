        ...
        <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <form method="post">
                        <input type="hidden" name="idVenta" IdVenta="idVenta" value="<?php echo $Ventas['IdVenta'];?>">
                        <input type="submit" name="AnularVenta" value="Anular" class="btn btn-primary" onclick="return Anular()">
                    </form>
                </tr>
                <?php }         
                    ?>
