...
//En caso de apretar el boton imprimir informe, se pregunta si se selecciono "Peliculas" o "ProximasPeliculas", para ser redireccionado
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="InformePeliculas.php" method="post">
                <div class="row">
                    Peliculas <input type="radio" <?php echo ($rdgTipo == "Peliculas") ? "checked" : ""; ?> name="Tipo"
                        value="Peliculas">
                </div>
                <div class="row">
                    Proximas Peliculas <input type="radio" <?php echo ($rdgTipo == "ProximasPeliculas") ? "checked" : ""; ?>
                        name="Tipo" value="ProximasPeliculas">
                </div>
                <br />
                <div class="col">
                    <button type="submit" name="SeleccionarInforme" class="btn btn-info">Seleccionar Tipo
                        Informe</button>
